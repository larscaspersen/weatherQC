#' Impute gaps in daily weather data using inverse distance weightening
#' 
#' Takes data.frame of daily weather data of several neighboring weather stations
#' and imputes gaps with the inverse distance weightening (idw) method.
#' 
#' Add citation and more detailed description of idw
#' 
...
#' decimal format
#' @param phi distance weightening factor, the higher the factor, the more penalized
